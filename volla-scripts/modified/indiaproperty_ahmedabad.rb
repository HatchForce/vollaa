...
def get_properties(i)
  ...
  x.each do |x|
    ...
    more_link = "http://ahmedabad.indiaproperty.com" + div_child.children()[2].children()[2].children()[0].children()[2].children()[0].attributes['href'] rescue ""
    created_at = Time.now
    puts x
  ...
  File.open("indiaproperty_ahmedabad_#{@timestamp}.txt", 'a+') do |f|
